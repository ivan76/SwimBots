...
function Obstacle() {
	...
	function calculateStuff() {
		...
		if (_end1.position.x > right) { _end1.position.x = right; } else if (_end1.position.x < left) { _end1.position.x = left; }
		if (_end1.position.y > bottom) { _end1.position.y = bottom; } else if (_end1.position.y < top) { _end1.position.y = top; }

		if (_end2.position.x > right) { _end2.position.x = right; } else if (_end2.position.x < left) { _end2.position.x = left; }
		if (_end2.position.y > bottom) { _end2.position.y = bottom; } else if (_end2.position.y < top) { _end2.position.y = top; }
	}
